...
if __name__ == "__main__":
    ...
    if not os.path.exists("all_urls.txt") and not os.path.exists("index.txt") and not os.path.exists("words.txt"):
        build_inverted_index("/Users/davidchen/inf141/Assignment3/DEV")
